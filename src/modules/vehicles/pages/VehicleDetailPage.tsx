      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <aside className="md:col-span-1">
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm sticky top-24">
            ...
            <p className="text-3xl font-extrabold text-green-600 mb-1">{formatCurrency(price)}</p>
            <p className="text-xs text-gray-400 mb-6">ou consulte condições de financiamento</p>

            <button
              className="w-full bg-green-600 text-white py-3 px-4 rounded-xl font-semibold hover:bg-green-700 active:scale-95 transition-all mb-3"
              onClick={() => alert('Em breve entraremos em contato!')}
            >
              Tenho interesse
            </button>
            <button
              className="w-full bg-white text-green-600 border border-green-200 py-3 px-4 rounded-xl font-semibold hover:bg-green-50 active:scale-95 transition-all"
